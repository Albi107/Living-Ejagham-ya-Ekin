...
namespace Museum_Practitioner.Views
{
    ...
    public partial class Special_Posters : ContentPage
    {
        public Special_Posters()
        {
            InitializeComponent();
        }
        ...
        {
            base.OnAppearing();
            Sp.ItemsSource = new Posters.PosterService().GetPostersList();
        }

        public class Posters
        {
            public class PosterCut
            {
            ...
            {
                public List<PosterCut> GetPostersList()
                {
                    return new List<PosterCut>()
                {
                new PosterCut()
                ...
                "the use of cultural education as effective tool for combating corruption and evolving new orientation for society. ", Authors = "Abu S. Edet", Year = "Published 20o4" , ButtonClicked = "https://www.researchgate.net"},
                    new PosterCut()
                    { BookName = "Cultural Heritage: A tool for Poverty Eradication and Social Development in Nigeria", BookImage = "WA0027.jpg", BookDescription = "The Cross River Monolith, bclg,CRTUd,tu,qIGOUQ " +
                    "UGWuibv/oP//BVYVIW BHIWG bcbiw iwyieyggyliw  iwyEF8YGF VFLVUVL yeg792    ahhfviyvaif vauvfyi IE9Pje",Authors="Abu S. Edet" , ButtonClicked = "https://www.researchgate.net"}
                 };
                }
            }
        }
