...
namespace Museum_Practitioner.Views
{
    ...
    public partial class Exhibition_Designed_and_Curated : ContentPage
    {
        public Exhibition_Designed_and_Curated()
        {
            InitializeComponent();
        }
        ...
        {
            base.OnAppearing();
            Exbt.ItemsSource = new Exbtdc.ExbtdcService().GetExbtdcsList();
        }

        public class Exbtdc
        {
            public class ExbtdcCut
            {
            ...
            public class ExbtdcService
            {
                public List<ExbtdcCut> GetExbtdcsList()
                {
                    return new List<ExbtdcCut>()
                {
                new ExbtdcCut()
